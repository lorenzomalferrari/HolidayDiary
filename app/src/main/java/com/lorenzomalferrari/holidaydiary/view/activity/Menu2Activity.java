...
public class Menu2Activity extends AppCompatActivity
    ...
    private void actionTravel(){
        travel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Menu2Activity.this, AddTravelActivity.class);
    ...
    private void actionNote(){
        note.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Menu2Activity.this, AddNoteActivity.class);
                Menu2Activity.this.startActivity(intent);
                // Pulisco la visualizzazione dei bottoni
                closeFloatingActionMenu();
            }
    ...
    private void actionPicture(){
        picture.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Menu2Activity.this, AddPictureActivity.class);
                Menu2Activity.this.startActivity(intent);
                // Pulisco la visualizzazione dei bottoni
                closeFloatingActionMenu();
            }
